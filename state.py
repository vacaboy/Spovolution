...
class buffbet1(state):
    ...
    def calculateblessing(self):
        ...
        for w in winner:
            self.buff.effect(w)
            print(w.name + " won this effect!")
            print("he got: " + self.buff.text)
